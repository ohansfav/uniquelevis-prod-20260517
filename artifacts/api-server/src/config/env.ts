...
const env = {
  ...
  BILLING_AMOUNT_SILVER: Number(process.env.BILLING_AMOUNT_SILVER ?? 500),
  BILLING_AMOUNT_GOLD: Number(process.env.BILLING_AMOUNT_GOLD ?? 1000),
  BILLING_AMOUNT_DIAMOND: Number(process.env.BILLING_AMOUNT_DIAMOND ?? 1500),
